<div :class="`bb-song-player ${dragging ? 'dragging' : ''} ${resizing ? 'resizing' : ''}`">
	<div class="control-panel">
		...
		<b-dropdown variant="secondary">
			...
			<b-dropdown-item href="javascript:" @click="openShareDialog()"><fa icon="share-from-square" fixed-width/> Share...</b-dropdown-item>
			<b-dropdown-item href="javascript:" @click="openImportDialog()"><fa icon="file-import" fixed-width/> Open...</b-dropdown-item>
			<b-dropdown-item href="javascript:" @click="clearSong()"><fa icon="trash" fixed-width/> Clear song</b-dropdown-item>
			<b-dropdown-item href="javascript:" @click="downloadMP3()"><fa icon="file-audio" fixed-width/> Export MP3</b-dropdown-item>
			<b-dropdown-item href="javascript:" @click="downloadWAV()"><fa icon="file-audio" fixed-width/> Export WAV</b-dropdown-item>
		</b-dropdown>
		<div
